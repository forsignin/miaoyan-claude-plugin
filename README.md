...
一个 Claude Code 插件,智能生成专业的妙言 Markdown 演示文稿,完整支持 Reveal.js 特性。

> 💡 本插件专为 [妙言](https://miaoyan.app/) 设计 - 一款优雅强大的 macOS Markdown 编辑器,内置 Reveal.js 演示支持。

## 关于

妙言 PPT 生成器是一个 **Claude Code 插件**,它可以帮助你快速创建适用于妙言编辑器的专业演示文稿。通过 AI 辅助,你可以:
...
- [妙言](https://miaoyan.app/) - 用于预览和演示生成的 PPT
...
- 作者: forsignin
- GitHub: https://github.com/forsignin/miaoyan-claude-plugin
- Issue: https://github.com/forsignin/miaoyan-claude-plugin/issues

---

**在 Claude Code 中享受创作演示文稿的乐趣吧!** 🎉
